      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-2">
            <Link href="/">
              <div className="w-8 h-8 bg-gradient-to-br from-violet-500 to-purple-600 rounded-lg flex items-center justify-center cursor-pointer">
                <Sparkles className="w-5 h-5 text-white" />
              </div>
            </Link>
            <Link href="/" className="text-xl font-bold text-white">LuzeN</Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link href="/login" className="px-4 py-2 text-gray-300 hover:text-white transition-colors duration-200 text-sm font-medium">
              Zaloguj się
            </Link>
            <Link href="/register" className="px-5 py-2 bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-lg font-medium text-sm hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105">
              Rozpocznij teraz
            </Link>
          </div>
          ...
          <div className="md:hidden bg-slate-900/95 backdrop-blur-lg rounded-b-2xl shadow-xl">
            <div className="px-4 py-6 space-y-3">
              ...
              <div className="pt-4 space-y-3 border-t border-white/10">
                <Link
                  href="/login"
                  className="w-full px-4 py-2 text-gray-300 hover:text-white transition-colors duration-200 block text-center rounded-lg"
                  onClick={() => setIsOpen(false)}
                >
                  Zaloguj się
                </Link>
                <Link
                  href="/register"
                  className="w-full px-5 py-2 bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-lg font-medium block text-center"
                  onClick={() => setIsOpen(false)}
                >
                  Rozpocznij teraz
                </Link>
