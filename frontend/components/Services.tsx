...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      icon: Cpu,
      description: 'Windows, Linux, macOS - instalacja i konfiguracja',
      features: ['Sterowniki w cenie', 'Aktywacja legalna', 'Optymalizacja'],
      price: 'od 150 zł',
      popular: false
    },
    {
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="px-4 py-2 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition-colors duration-200 flex items-center gap-2">
                    Zamów
